...
ENHANCEMENT_SYSTEM_PROMPT_IMPROVISE = """You are an expert Business Analyst and Technical Writer specializing in requirement analysis and improvement. Your role is to enhance software requirements to make them clearer, more complete, and better structured for test case generation.
...
ENHANCEMENT_SYSTEM_PROMPT_GRAMMAR = """You are an expert copy editor specializing in technical documentation. Your role is to fix spelling and grammatical errors in software requirements while preserving the original meaning and structure.

Return your analysis as JSON with this exact structure:
{
  "enhanced_requirement": "The requirement text with spelling and grammar corrections applied",
  "improvements_made": [
    "Fixed spelling error: 'recieve' → 'receive'",
    "Corrected subject-verb agreement in paragraph 2",
    "Fixed punctuation in list items"
  ],
  "quality_issues_found": [
    "Spelling errors",
  ...
  "suggestions_applied": [
    "Corrected all spelling mistakes",
...
2. Correct grammatical mistakes (subject-verb agreement, tense consistency, etc.)
3. Fix punctuation errors
4. Maintain the original structure and content
5. Do NOT add new content or requirements
6. Do NOT restructure or reorganize the text
7. Do NOT add acceptance criteria or additional details
8. Only fix language errors while preserving the original meaning"""

ENHANCEMENT_SYSTEM_PROMPT = ENHANCEMENT_SYSTEM_PROMPT_IMPROVISE

ENHANCEMENT_USER_TEMPLATE_IMPROVISE = """Analyze and enhance this software requirement for optimal test case generation:
...
ENHANCEMENT_USER_TEMPLATE_GRAMMAR = """Fix spelling and grammatical errors in this software requirement:

ORIGINAL REQUIREMENT:
{requirement_text}

Please correct:
1. All spelling mistakes
2. Grammatical errors (subject-verb agreement, tense, etc.)
3. Punctuation issues

IMPORTANT: Only fix language errors. Do NOT add new content, requirements, or restructure the text. Preserve the original meaning and structure."""

ENHANCEMENT_USER_TEMPLATE = ENHANCEMENT_USER_TEMPLATE_IMPROVISE
...
class RequirementEnhancementAgent:
    ...
    def enhance_requirement(self, requirement_text: str, source_file: str = None, enhancement_type: str = 'improvise') -> Dict:
        """
        ...
        """
        logger.info(f"📝 Starting requirement enhancement analysis (type: {enhancement_type})...")
        
        try:
            # Select appropriate prompts based on enhancement type
            if enhancement_type == 'fix-grammar':
                system_prompt = ENHANCEMENT_SYSTEM_PROMPT_GRAMMAR
                user_template = ENHANCEMENT_USER_TEMPLATE_GRAMMAR
            else:  # Default to 'improvise'
                system_prompt = ENHANCEMENT_SYSTEM_PROMPT_IMPROVISE
                user_template = ENHANCEMENT_USER_TEMPLATE_IMPROVISE
